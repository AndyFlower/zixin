package com.slp.version3.utils;
...
public class LogUtils {
     ...
     *
     */
    @Pointcut("execution(public int com.slp.version3.inter.impl.MyCalculator2.*(int,int))")
    public void MyPoint(){
    ...
    @Before("execution(public int com.slp.version3.inter.impl.MyCalculator2.*(int,int))")
     ...
     */
    @AfterReturning("execution(public int com.slp.version3.inter.impl.MyCalculator2.*(int,int))")
     ...
     * @param result
     */
    @AfterReturning(returning = "result",value="execution(public int com.slp.version3.inter.impl.MyCalculator2.*(int,int))")
     ...
     * @param
     */
    @AfterThrowing(throwing = "exception",value="execution(public int com.slp.version3.inter.impl.MyCalculator2.*(int,int))")
