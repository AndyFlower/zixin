...
3. 设计思想
当你学习一个框架的时候，不仅仅要学会如何When you learn about a framework, it’s important to know not only what it does but what principles it follows. Here are the guiding principles of the Spring Framework:
