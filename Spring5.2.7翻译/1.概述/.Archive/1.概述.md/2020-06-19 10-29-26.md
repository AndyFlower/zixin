...
Spring使得创建一个企业级java应用变的简单。它提供了在企业环境中使用java语言所需的一切 ，并且支持Groovy和Kotlin作为JVM上的替代语言
 It provides everything you need to embrace the Java language in an enterprise environment, with support for Groovy and Kotlin as alternative languages on the JVM, and with the flexibility to create many kinds of architectures depending on an application’s needs. 对于``Spring``框架的5.1以上，需要``JDK8``以上版本 ，并且也支持``JDK11 LTS``开箱即用。建议` Java SE 8`的更新60作为java8的最小补丁版本，但是通常建议使用最近的补丁版本 .
